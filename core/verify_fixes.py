...
print("Server output should show: '[API] God Mode and Chat Mode enabled -> Voice disabled'")
if res.status_code == 200:
    print(f"Response: {res.json().get('content')}")
else:
...
res = requests.post(SERVER_URL, json={
    "message": "Hi Orion! Just a quick fact for you: My favorite color is neon green.",
    "god_mode": False,
    "chat_mode": False
})
if res.status_code == 200:
