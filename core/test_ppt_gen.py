...
content_map = {
    "Introduction": ["- Welcome to Orion", "- This is a test slide", "- here are the bullet points ignore this"],
    "Core_Architecture": ["- Modular Design", "- Dark_Theme_Enabled", "- python-pptx"],
    "Future_Outlook": ["- Scaling Up", "- Mobile Integration", "- Total Sovereignty"]
}
