...
def simulate_attack():
    ...
    try:
        ...
        telemetry = {
            "type": "TELEMETRY",
            "category": "WIN_EVENT",
            "payload": "EventId: 4625, Message: An account failed to log on. Account Name: Admin. Source Network Address: 192.168.1.50",
            "timestamp": time.time()
        }
        ...
        try:
            ...
            if response:
                print(f"⚠️ RECEIVED COMMAND FROM ORION: {response.decode('utf-8').strip()}")
