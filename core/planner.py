...
class OrionPlanner:
    ...
    def plan(self, goal: str, context: str = "") -> dict:
        ...
        prompt = (
            ...
            f"CONTEXT: {context}\n"
            f"{pref_context}\n"
            "You are a tactical planner. Break this goal into a sequential list of steps.\n"
            ...
            "{\n"
            "  \"steps\": [\n"
            "    {\"action\": \"FILE_WRITE\", \"payload\": {\"path\": \"hello.py\", \"content\": \"print('Hello')\"}, \"description\": \"Create script\"},\n"
            "    {\"action\": \"SHELL_EXECUTE\", \"payload\": {\"command\": \"python hello.py\"}, \"description\": \"Run script\"}\n"
            "  ]\n"
            "}"
        )
